...
var app = angular.module('app.auth', [
    'ui.router', 'ui.bootstrap', 'ui.grid', 'ui.grid.grouping', 'chart.js',
    'ui.grid.pagination', 'ui.grid.selection', 'ui.grid.exporter', 'ui.grid.autoFitColumns', 'ui.grid.resizeColumns', 'ui.grid.autoResize', 'ui.grid.moveColumns', 'ui.grid.pinning',
   ...
   .state('distributor_authentification', {
       url: '/distributor_authentification',
       views: {
           root: {
               templateUrl: 'app/auth/views/distributor_authentification.html'
           }
       },
       data: {
           title: 'distributor_authentification',
           htmlId: 'distributor_authentification'
       }
   })



   .state('distributor_profile', {
       url: '/distributor_profile',
       views: {
           root: {
               templateUrl: 'app/auth/views/distributor_profile.html',
               controller: 'distributor_profile'
           }
       },
       data: {
           title: 'distributor_profile',
           htmlId: 'distributor_profile'
       }
   })

   .state('create_administrator_account', {
       url: '/create_administrator_account',
       views: {
           root: {
               templateUrl: 'app/auth/views/create_administrator_account.html'
           },
           data: {
               title: 'create_administrator_account',
               htmlId: 'create_administrator_account'
           }
       }
   })
...
var appdash = angular.module('app.dashboard', [
    'ui.router', 'angularjs-crypto', 'ngStorage', 'chart.js', 'ngFileUpload', 'naif.base64', 'oitozero.ngSweetAlert',
    'ngBase64', 'imagebase64', 'ngResource', 'ui.grid', 'ui.grid.pagination', 'ui.grid.selection', 'ui.grid.exporter', 'oitozero.ngSmartAlert',
...
.config(function ($stateProvider) {
    ...
    $stateProvider
        ...
        // Dashboards
           .state('app.dashboard.dashboard_ezy_gas', {
               url: '/dashboard_aegis',
               views: {
                   "content@app": {
                       controller: 'AdminDashboard',
                       templateUrl: 'app/dashboard/partials/dashboard_eazy_gas.html'
                   }
               },
               data: {
                   title: tabTitle
        ...
        //for new dashboard
         .state('app.dashboard.new_dashboard', {
             url: '/advance_dashboard',
             module: 'newdashboard',
             views: {
                 "content@app": {
                     controller: 'NewAdminDashboardController',
                     templateUrl: 'app/dashboard/partials/new_dashboard.html'
                 }
             },
             data: {
                 title: tabTitle
         ...
         .state('app.dashboard.digital_dashboard', {
             url: '/digital_dashboard',
             module: 'newdashboard',
             views: {
                 "content@app": {
                     controller: 'DigitalDashboardController',
                     templateUrl: 'app/dashboard/partials/digital_dashboard.html'
                 }
             },
             data: {
                 title: tabTitle
         ...
         .state('app.dashboard.dash_deliverydetails', {
             url: '/dash_deliverydetails',
             module: 'newdashboard',
             views: {
                 "content@app": {
                     controller: 'NewAdminDeliveryDetController',
                     templateUrl: 'app/dashboard/partials/dash_deliverydetails.html'
                 }
             },
             data: {
                 title: tabTitle
         ...
         .state('app.dashboard.dash_digitalpaymentdet', {
             url: '/dash_digitalpaymentdet',
             module: 'newdashboard',
             views: {
                 "content@app": {
                     controller: 'DigitalPaymentDetController',
                     templateUrl: 'app/dashboard/partials/dash_digitalpaymentdet.html'
                 }
             },
             data: {
                 title: tabTitle
         ...
         .state('app.dashboard.totaldigitalpayments', {
             url: '/totaldigitalpayments',
             module: 'newdashboard',
             views: {
                 "content@app": {
                     controller: 'TotalDigitalPaymentsController',
                     templateUrl: 'app/dashboard/partials/totaldigitalpayments.html'
                 }
             },
             data: {
                 title: tabTitle
         ...
         .state('app.dashboard.smartcardsalepotential', {
             url: '/smartcardsalepotential',
             module: 'newdashboard',
             views: {
                 "content@app": {
                     controller: 'SmartCardPotentialsController',
                     templateUrl: 'app/dashboard/partials/smartcardsalepotential.html'
                 }
             },
             data: {
                 title: tabTitle
         ...
         .state('app.dashboard.ezygasusage', {
             url: '/gogasusage',
             module: 'newdashboard',
             views: {
                 "content@app": {
                     controller: 'EZYGASPotentialsController',
                     templateUrl: 'app/dashboard/partials/ezygasusage.html'
                 }
             },
             data: {
                 title: tabTitle
        ...
        .state('app.dashboard.onboardingpotential', {
            url: '/onboardingpotential',
            module: 'newdashboard',
            views: {
                "content@app": {
                    controller: 'DigitalPaymentOnboardingPotentialsController',
                    templateUrl: 'app/dashboard/partials/onboardingpotential.html'
                }
            },
            data: {
                title: tabTitle
             ...
             .state('app.dashboard.ezydelversiondetails', {
                 url: '/godelversiondetails',
                 views: {
                     "content@app": {
                         controller: 'EzyDeliveryVersionDetController',
                         templateUrl: 'app/dashboard/partials/ezy_delivery_vr_details.html'
                     }
                 },
                 data: {
                     title: tabTitle
            ...
            .state('app.dashboard.transeferredcons', {
                url: '/transeferred_consumers',
                views: {
                    "content@app": {
                        controller: 'TranseferredConsController',
                        templateUrl: 'app/dashboard/partials/transferred_consumer.html'
                    }
                },
                data: {
                    title: tabTitle
                   ...
                   .state('app.dashboard.lead_allocation', {
                       url: '/lead_allocation',
                       views: {
                           "content@app": {
                               templateUrl: 'app/dashboard/partials/lead_allocation.html'
                           }
                       },
                       data: {
                           title: tabTitle
                         ...
                         .state('app.dashboard.workrequest_list', {
                             url: '/workrequest_list',
                             views: {
                                 "content@app": {
                                     templateUrl: 'app/dashboard/partials/workrequest_list.html'
                                 }
                             },
                             data: {
                                 title: tabTitle
                               ...
                               .state('app.dashboard.workrequest_details', {
                                   url: '/workrequest_details',
                                   views: {
                                       "content@app": {
                                           templateUrl: 'app/dashboard/partials/workrequest_details.html'
                                       }
                                   },
                                   data: {
                                       title: tabTitle
          ...
          .state('app.dashboard.misreport', {
              url: '/mis_report',
              views: {
                  "content@app": {
                      controller: 'MISReportController',
                      templateUrl: 'app/dashboard/partials/mis_report.html'
                  }
              },
              data: {
                  title: tabTitle
           ...
           .state('app.dashboard.digital_payment_details', {
               url: '/digital_payment_details',
               views: {
                   "content@app": {
                       controller: 'DigitalPaymentReportController',
                       templateUrl: 'app/dashboard/partials/digital_payment_details.html'
                   }
               },
               data: {
                   title: tabTitle
         ...
         .state('app.dashboard.consumerbase_location', {
             url: '/consumerbase_location',
             views: {
                 "content@app": {
                     controller: 'ConsumerBaseLocationReportController',
                     templateUrl: 'app/dashboard/partials/consumerbase_location.html'
                 }
             },
             data: {
                 title: tabTitle
           ...
           .state('app.dashboard.mosambee_delboy_report', {
               url: '/mosambee_delboy_report',
               module: 'mosambee',
               views: {
                   "content@app": {
                       controller: 'MosambeeDelBoyReportController',
                       templateUrl: 'app/dashboard/partials/mosambee_delboy_report.html'
                   }
               },
               data: {
                   title: tabTitle
          ...
          .state('app.dashboard.mosambee_delboy', {
              url: '/mosambee_delboy',
              module: 'mosambee',
              views: {
                  "content@app": {
                      controller: 'MosambeeDelBoyController',
                      templateUrl: 'app/dashboard/partials/mosambee_delboy.html'
                  }
              },
              data: {
                  title: tabTitle
          ...
          .state('app.dashboard.pending_cashmemo_report', {
              url: '/pending_cashmemo_report',
              module: 'mosambee',
              views: {
                  "content@app": {
                      controller: 'PendingCashMemoReportController',
                      templateUrl: 'app/dashboard/partials/pending_cashmemo_report.html'
                  }
              },
              data: {
                  title: tabTitle
         ...
         .state('app.dashboard.dashboard_My_Express_gas', {
             url: '/dashboard_My_Express_gas',
             views: {
                 "content@app": {
                     controller: 'AdminDashboard',
                     templateUrl: 'app/dashboard/partials/dashboard_My_Express_gas.html'
                 }
             },
             data: {
                 title: tabTitle
        ...
        .state('app.dashboard.state_master_grid', {
            url: '/state_master_grid',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/state_master_grid.html',
                    controller: 'StateMasterGridController'
                }
            }
        })
         .state('app.dashboard.District_master_grid', {
             url: '/District_master_grid',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/District_master_grid.html',
                     controller: 'DistrictMasterGridController'
                 }
             }
         })
          .state('app.dashboard.primary_product_master_grid', {
              url: '/primary_product_master_grid',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/primary_product_master_grid.html',
                      controller: 'PrimaryProductMasterGridController'
                  }
              }
          })
    .state('app.dashboard.taluka_master_grid', {
        url: '/taluka_master_grid',
        views: {
            "content@app": {
                templateUrl: 'app/dashboard/partials/taluka_master_grid.html',
                controller: 'TalukaMasterGridController'
            }
        }
    })

    .state('app.dashboard.inword_master_grid', {
        url: '/inword_master_grid',
        views: {
            "content@app": {
                templateUrl: 'app/dashboard/partials/inword_master_grid.html',
                controller: 'InwardMasterGridController'
            }
        }
    })

     .state('app.dashboard.state_master', {
         url: '/state_master',
         views: {
             "content@app": {

                 templateUrl: 'app/dashboard/partials/state_master.html',
                 controller: 'StateMasterController'
             }
         }
     })

         .state('app.dashboard.district_master', {
             url: '/district_master',
             views: {
                 "content@app": {

                     templateUrl: 'app/dashboard/partials/district_master.html',
                     controller: 'DistrictMasterController'
                 }
             }
         })

         .state('app.dashboard.taluka_master', {
             url: '/taluka_master',
             views: {
                 "content@app": {

                     templateUrl: 'app/dashboard/partials/taluka_master.html',
                     controller: 'TalukaMasterController'
                 }
             }
         })
         .state('app.dashboard.primary_product_master', {
             url: '/primary_product_master',
             views: {
                 "content@app": {

                     templateUrl: 'app/dashboard/partials/primary_product_master.html',
                     controller: 'PrimaryProductMasterController'
                 }
             }
         })


        .state('app.dashboard.inword_master', {
            url: '/inword_master',
            views: {
                "content@app": {

                    templateUrl: 'app/dashboard/partials/inword_master.html',
                    controller: 'InwardMasterController'
                }
            }
        })
     .state('app.dashboard.user_role_grid', {
         url: '/user_role_grid',
         views: {
             "content@app": {
                 templateUrl: 'app/dashboard/partials/user_role_grid.html',
                 controller: 'UserRoleGridController'
             }
         }
     })
        .state('app.dashboard.user_role', {
            url: '/user_role',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/user_role.html',
                    controller: 'UserRoleController'

                }
            }
        })
          .state('app.dashboard.block_smart_card_reasons_grid', {
              url: '/block_smart_card_reasons_grid',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/block_smart_card_reasons_grid.html',
                      controller: 'BlockSmartCardGridController'
                  }
              }
          })
          .state('app.dashboard.product_group_grid', {
              url: '/product_group_grid',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/product_group_grid.html',
                      controller: 'ProductGroupGridController'
                  }
              }
          })
          .state('app.dashboard.product_group', {
              url: '/product_group',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/product_group.html',
                       controller: 'ProductGroupController'
                  }
              }
          })
            .state('app.dashboard.product_class_grid', {
                url: '/product_class_grid',
                views: {
                    "content@app": {
                        templateUrl: 'app/dashboard/partials/product_class_grid.html',
                        controller: 'ProductClassGridController'
                    }
                }
            })
          .state('app.dashboard.product_class', {
              url: '/product_class',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/product_class.html',
                      controller: 'ProductClassController'
                  }
              }
          })
              .state('app.dashboard.actual_product_grid', {
                  url: '/actual_product_grid',
                  views: {
                      "content@app": {
                          templateUrl: 'app/dashboard/partials/actual_product_grid.html',
                          controller: 'ActualProductGridController'
                      }
                  }
              })
          .state('app.dashboard.actual_product', {
              url: '/actual_product',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/actual_product.html',
                      controller: 'ActualProductController'
                  }
              }
          })


          .state('app.dashboard.block_smart_card_reasons', {
              url: '/block_smart_card_reasons',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/block_smart_card_reasons.html',
                      controller: 'BlockSmartCardController'
                  }
              }
          })

        .state('app.dashboard.transport_mode_grid', {
            url: '/transport_mode_grid',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/transport_mode_grid.html',
                    controller: 'TransportMasterGridController'
                }
            }
        })

          .state('app.dashboard.transport_mode', {
              url: '/transport_mode',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/transport_mode.html',
                      controller: 'TransportMasterController'
                  }
              }
          })

        .state('app.dashboard.pay_mode_grid', {
            url: '/pay_mode_grid',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/pay_mode_grid.html',
                    controller: 'PaymentModeDeviceGridController'
                }
            }
        })

         .state('app.dashboard.pay_mode', {
             url: '/pay_mode',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/pay_mode.html',
                     controller: 'PayModeController'
                 }
             }
         })
         .state('app.dashboard.payment_mode_grid', {
             url: '/payment_mode_grid',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/payment_mode_grid.html',
                     controller: 'PaymentModeGridController'
                 }
             }
         })

         .state('app.dashboard.payment_mode', {
             url: '/payment_mode',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/payment_mode.html',
                     controller: 'PaymentModeController'
                 }
             }
         })

          .state('app.dashboard.bank_master_grid', {
              url: '/bank_master_grid',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/bank_master_grid.html',
                      controller: 'BankMasterGridController'
                  }
              }
          })
         .state('app.dashboard.bank_master', {
             url: '/bank_master',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/bank_master.html',
                     controller: 'BankMasterController'
                 }
             }
         })

        .state('app.dashboard.region_master_grid', {
            url: '/region_master_grid',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/region_master_grid.html',
                    controller: 'RegionMasterGridController'
                }
            }
        })

          .state('app.dashboard.region_master', {
              url: '/region_master',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/region_master.html',
                      controller: 'RegionMasterController'
                  }
              }
          })

        .state('app.dashboard.pdc_question_grid', {
            url: '/pdc_question_grid',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/pdc_question_grid.html',
                    controller: 'ViewPDCQuestionController'
                }
            }
        })
            .state('app.dashboard.pdc_question', {
                url: '/pdc_question',
                views: {
                    "content@app": {
                        templateUrl: 'app/dashboard/partials/pdc_question.html',
                        controller: 'PDCQuestionController'
                    }
                }
            })


             .state('app.dashboard.manufacture_grid', {
                 url: '/manufacture_grid',
                 views: {
                     "content@app": {
                         templateUrl: 'app/dashboard/partials/manufacture_grid.html',
                         controller: 'ManufactureMasterGridController'
                     }
                 }
             })
            .state('app.dashboard.manufacture', {
                url: '/manufacture',
                views: {
                    "content@app": {
                        templateUrl: 'app/dashboard/partials/manufacture.html',
                        controller: 'ManufactureMasterController'
                    }
                }
            })
             .state('app.dashboard.plant_grid', {
                 url: '/plant_grid',
                 views: {
                     "content@app": {
                         templateUrl: 'app/dashboard/partials/plant_grid.html',
                         controller: 'PlantMasterGridController'
                     }
                 }
             })
            .state('app.dashboard.plant', {
                url: '/plant',
                views: {
                    "content@app": {
                        templateUrl: 'app/dashboard/partials/plant.html',
                        controller: 'PlantMasterController'
                    }
                }
            })
            .state('app.dashboard.cylinder_providers_grid', {
                url: '/cylinder_providers_grid',
                views: {
                    "content@app": {
                        templateUrl: 'app/dashboard/partials/cylinder_providers_grid.html',
                        controller: 'CylProviderDetailController'
                    }
                }
            })
            .state('app.dashboard.cylinder_providers', {
                url: '/cylinder_providers',
                views: {
                    "content@app": {
                        templateUrl: 'app/dashboard/partials/cylinder_providers.html',
                        controller: 'CylProviderController'
                    }
                }
            })

          .state('app.dashboard.exclude_ro_grid', {
              url: '/exclude_ro_grid',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/exclude_ro_grid.html',
                      controller: 'ExcludeROGridController'
                  }
              }
          })
            .state('app.dashboard.exclude_ro', {
                url: '/exclude_ro',
                views: {
                    "content@app": {
                        templateUrl: 'app/dashboard/partials/exclude_ro.html',
                        controller: 'ExcludeROController'
                    }
                }
            })

           .state('app.dashboard.weight_report', {
               url: '/weight_report',
               views: {
                   "content@app": {
                       templateUrl: 'app/dashboard/partials/weight_report.html',
                       controller: 'WeightReportController'
                   }
               }
           })

          .state('app.dashboard.pdc_weight_setting', {
              url: '/pdc_weight_setting',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/pdc_weight_setting.html',
                      controller: 'PDC&WeightSettingController'
                  }
              }
          })


             .state('app.dashboard.pdc_report', {
                 url: '/pdc_report',
                 views: {
                     "content@app": {
                         templateUrl: 'app/dashboard/partials/pdc_report.html',
                         controller: 'PDCController'
                     }
                 }
             })
         ...
         .state('app.dashboard.language_master_grid', {
             url: '/language_master_grid',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/language_master_grid.html',
                     controller: 'LanguageMasterGridController'
                 }
             }
         })

           .state('app.dashboard.language_master', {
               url: '/language_master',
               views: {
                   "content@app": {
                       templateUrl: 'app/dashboard/partials/language_master.html',
                       controller: 'LanguageMasterController'
                   }
               }
           })
         .state('app.dashboard.zonemaster_grid', {
             url: '/zonemaster_grid',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/zonemaster_grid.html',
                     controller: 'ZoneGridController'

                 }
             }
         })

         .state('app.dashboard.zonemaster', {
             url: '/zonemaster',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/zonemaster.html',
          ...
          .state('app.dashboard.region', {
              url: '/region',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/region.html',
                      controller: 'RegionController'

                  }
              }
          })
        .state('app.dashboard.region_grid', {
            url: '/region_grid',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/region_grid.html',
                    controller: 'RegionGridController'
           ...
           .state('app.dashboard.transport_charges_grid', {
               url: '/transport_charges_grid',
               views: {
                   "content@app": {
                       templateUrl: 'app/dashboard/partials/transport_charges_grid.html',
                       controller: 'TransportationChargesGridController'
                   }
               }
           })
             .state('app.dashboard.transport_charges', {
                 url: '/transport_charges',
                 views: {
                     "content@app": {
                         templateUrl: 'app/dashboard/partials/transport_charges.html',
                         controller: 'TransportationChargesController'
                     }
                 }
             })

             .state('app.dashboard.mail_master_grid', {
                 url: '/mail_master_grid',
                 views: {
                     "content@app": {
                         templateUrl: 'app/dashboard/partials/mail_master_grid.html',
                         controller: 'EmailDetailsGridController'
                     }
                 }
             })
        .state('app.dashboard.mail_master', {
            url: '/mail_master',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/mail_master.html',
                    controller: 'EmailDetailsController'

                }
            }
        })
         .state('app.dashboard.xpressg_appgrid', {
             url: '/aegis_appgrid',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/xpressg_appgrid.html',
                     controller: 'ApplicationNameGridController'

                 }
             }
         })
         .state('app.dashboard.xpressg_application', {
             url: '/aegis_application',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/xpressg_application.html',
                     controller: 'ApplicationNameController'
                 }
             }
         })
        .state('app.dashboard.appversion_grid', {
            url: '/appversion_grid',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/appversion_grid.html',
         ...
         .state('app.dashboard.app_version', {
             url: '/app_version',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/app_version.html',
    ...
    //    end setup master
        ...
        //  Payment 
          ...
          .state('app.dashboard.plans_grid', {
              url: '/plans_grid',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/plans_grid.html',
                      controller: 'PlansValidityGridController'
                  }
              }
          })
           .state('app.dashboard.plans', {
               url: '/plans',
               views: {
                   "content@app": {
                       templateUrl: 'app/dashboard/partials/plans.html',
                       controller: 'PlansValidityController'
                   }
               }
           })
            .state('app.dashboard.product_grid', {
                url: '/product_grid',
                views: {
                    "content@app": {
                        templateUrl: 'app/dashboard/partials/product_grid.html',
           ...
           .state('app.dashboard.product', {
               ...
               views: {
                   "content@app": {
                       templateUrl: 'app/dashboard/partials/product.html',
                       controller: 'ProductController'
                   }
               }
           })
          .state('app.dashboard.transaction_grid', {
              url: '/transaction_grid',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/transaction_grid.html',
                      controller: 'TransactionGridController'
                  }
              }
          })
               .state('app.dashboard.pay_transaction_new', {
                   url: '/pay_transaction_new',
                   views: {
                       "content@app": {
                           templateUrl: 'app/dashboard/partials/pay_transaction_new.html',
                           controller: 'PaymentTransactionController'
                           
                       }
                   }
               })
           .state('app.dashboard.transaction', {
               url: '/transaction',
               views: {
                   "content@app": {
                       templateUrl: 'app/dashboard/partials/transaction.html',
                       controller: 'TransactionController'
                   }
               }
           })
         .state('app.dashboard.amc_payment_gateway_grid', {
             url: '/amc_payment_gateway_grid',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/amc_payment_gateway_grid.html',
                     controller: 'AMCPaymentGetwayGridController'
                 }
             }
         })
           .state('app.dashboard.amc_payment_gateway', {
               url: '/amc_payment_gateway',
               views: {
                   "content@app": {
                       templateUrl: 'app/dashboard/partials/amc_payment_gateway.html',
                       controller: 'AMCPaymentGetwayController'
                   }
               }
           })
          .state('app.dashboard.amc_arrears_grid', {
              url: '/amc_arrears_grid',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/amc_arrears_grid.html',
                      controller: 'AMCArrearsGridController'
                  }
              }
          })
           .state('app.dashboard.amc_arrears', {
               url: '/amc_arrears',
               views: {
                   "content@app": {
                       templateUrl: 'app/dashboard/partials/amc_arrears.html',
                       controller: 'AMCArrearsController'
                   }
               }
           })
         .state('app.dashboard.payment_gateway_grid', {
             url: '/payment_gateway_grid',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/payment_gateway_grid.html',
                     controller: 'PaymentGatewayGrid1Controller'
                 }
             }
         })
         .state('app.dashboard.payment_gateway', {
             url: '/payment_gateway',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/payment_gateway.html',
        ...
        //Distributor
        .state('app.dashboard.connect_distributor', {
            url: '/connect_distributor',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/connect_distributor.html',
                    controller: 'ConnectDistributorController'
                }
            }
        })

        .state('app.dashboard.product_allocation', {
            url: '/product_allocation',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/product_allocation.html',
                    controller: 'ProductAllocationController'
                }
            }
        })

        .state('app.dashboard.manage_service', {
            url: '/manage_service',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/manage_service.html',
                    controller: 'ManageServiceController'
                }
            }
        })

       .state('app.dashboard.manage_synchronize_pcs', {
           url: '/manage_synchronize_pcs',
           views: {
               "content@app": {
                   templateUrl: 'app/dashboard/partials/machine_activation.html'
               }
           }
       })

     .state('app.dashboard.manage_users', {
         url: '/manage_users',
         views: {
             "content@app": {
                 templateUrl: 'app/dashboard/partials/manage_users.html',
                 controller: 'ManageUserController'
             }
         }
     })

        .state('app.dashboard.generate_approval_mail', {
            url: '/generate_approval_mail',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/manage_distributor_grid.html'
                }
            }
        })
        .state('app.dashboard.place_an_order', {
            url: '/place_an_order',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/place_an_order.html'
                }
            }
        })
        .state('app.dashboard.dist_verify_payment', {
            url: '/dist_verify_payment',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/dist_verify_payment.html'
                }
            }
        })
        .state('app.dashboard.dist_outword', {
            url: '/dist_outword',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/dist_outword.html'
                }
            }
        })
        .state('app.dashboard.dist_opf_grid', {
            url: '/dist_opf_grid',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/dist_opf_grid.html',

                }
            }
        })
        .state('app.dashboard.dist_dispatch_grid', {
            url: '/dist_dispatch_grid',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/dist_dispatch_grid.html'
                }
            }
        })
         .state('app.dashboard.smart_card_serials', {
             url: '/dist_smart_card_serials',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/smart_card_serials.html'
                 }
             }
         })

         .state('app.dashboard.xpress_pay', {
             url: '/xpress_pay',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/manage_distributor_grid.html'
        ...
        .state('app.dashboard.other_settings', {
            url: '/other_settings',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/manage_distributor_grid.html'
          ...
          .state('app.dashboard.increase_validity', {
              url: '/increase_validity',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/increase_validity.html',
                      controller: 'IncreaseValidityController'
                  }
              }
          })
        .state('app.dashboard.distributor_payment_gateway_grid', {
            url: '/distributor_payment_gateway_grid',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/distributor_payment_gateway_grid.html',
                    controller: 'DistributorPaymentGatewayGridController'
                }
            }
        })
        .state('app.dashboard.distributor_payment_gateway', {
            url: '/distributor_payment_gateway',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/distributor_payment_gateway.html',
                    controller: 'DistributorPaymentGatewayController'
                }
            }
        })

        .state('app.dashboard.pre_login', {
            url: '/pre_login',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/manage_distributor_grid.html'
            ...
            .state('app.dashboard.hierarchy_of_distributor', {
                url: '/hierarchy_of_distributor',
                views: {
                    "content@app": {
                        templateUrl: 'app/dashboard/partials/hierarchy_details_of_distributor.html',
                        controller: 'HierarchyDetailsofDistributorController'
                    }
                }
            })
               .state('app.dashboard.price_allocation', {
                   url: '/price_allocation',
                   views: {
                       "content@app": {
                           templateUrl: 'app/dashboard/partials/price_allocation.html',
                           controller: 'PriceAllocationGridController'
                       }
                   }
               })
         .state('app.dashboard.upload_cylinder_data', {
             url: '/upload_cylinder_data',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/upload_cylinder_data.html',
                    controller: 'ImportXlsxController'
                }
            }
         })
           .state('app.dashboard.cylinder_master', {
               url: '/cylinder_master',
               views: {
                   "content@app": {
                       templateUrl: 'app/dashboard/partials/cylinder_master.html',
                       controller: 'CylinderMasterController'
                   }
               }
           })
          .state('app.dashboard.update_distributor', {
              url: '/update_distributor',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/update_distributor.html',
                      controller: 'UpdateDistributorController'
                  }
              }
          })
              .state('app.dashboard.update_act_deact', {
                  url: '/update_act_deact',
                  views: {
                      "content@app": {
                          templateUrl: 'app/dashboard/partials/update_act_deact.html',
                          controller: 'UpdateDistributorDataController'
                      }
                  }
              })
                  .state('app.dashboard.push_digital_payment_grid', {
                      url: '/push_digital_payment_grid',
                      views: {
                          "content@app": {
                              templateUrl: 'app/dashboard/partials/push_digital_payment_grid.html',
                              controller: 'PushDigitalPaymentGridController'
                          }
                      }
                  })
          .state('app.dashboard.push_digital_payment', {
              url: '/push_digital_payment',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/push_digital_payment.html',
                      controller: 'PushDigitalPaymentController'
                  }
              }
          })  


                .state('app.dashboard.vehicle-fitness', {
                    url: '/vehicle-fitness',
                    views: {
                        "content@app": {
                            templateUrl: 'app/dashboard/partials/vehicle-fitness.html'
                           
                        }
                    }
                })    
                       .state('app.dashboard.vehicle-fit-veiw', {
                           url: '/vehicle-fit-veiw',
                           views: {
                               "content@app": {
                                   templateUrl: 'app/dashboard/partials/vehicle-fit-veiw.html'
                    ...
                    .state('app.dashboard.add_channel_partner', {
                        url: '/add_channel_partner',
                        views: {
                            "content@app": {
                                templateUrl: 'app/dashboard/partials/add_channel_partner.html'
                         ...
                         .state('app.dashboard.godown-list', {
                             url: '/godown-list',
                             views: {
                                 "content@app": {
                                     templateUrl: 'app/dashboard/partials/godown-list.html'
                           
                                 }
                             }
                         })
           .state('app.dashboard.godown', {
               url: '/godown',
               views: {
                   "content@app": {
                       templateUrl: 'app/dashboard/partials/godown.html'

                   }
               }
           })   
                 .state('app.dashboard.appoinment_list', {
                     url: '/appoinment_list',
                     views: {
                         "content@app": {
                             templateUrl: 'app/dashboard/partials/appoinment_list.html'

                         }
                     }
                 })   
                        .state('app.dashboard.appintment_view', {
                            url: '/appintment_view',
                            views: {
                                "content@app": {
                                    templateUrl: 'app/dashboard/partials/appintment_view.html'

                                }
                            }
                        })    

                              .state('app.dashboard.add_leads', {
                                  url: '/add_leads',
                                  views: {
                                      "content@app": {
                                          templateUrl: 'app/dashboard/partials/add_leads.html'

                                      }
                                  }
                              })    
                                  
                              .state('app.dashboard.pipeline', {
                                  url: '/pipeline',
                                  views: {
                                      "content@app": {
                                          templateUrl: 'app/dashboard/partials/pipeline.html'
        ...
        //  Settings
        .state('app.dashboard.user_accounts_hpcl', {
            url: '/user_accounts_aegis',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/user_accounts_hpcl.html',
                    controller: 'UserAccountHPCLController'
                }
            }
        })
        .state('app.dashboard.user_account_hpcl_grid', {
            url: '/user_account_aegis_grid',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/user_account_hpcl_grid.html',
                    controller: 'UserAccountHPCLGridController'
                }
            }
        })
         .state('app.dashboard.user_accounts_iocl', {
             url: '/user_accounts_iocl',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/user_accounts_iocl.html',
                     controller: 'UserAccountIoclController'
                 }
             }
         })
        .state('app.dashboard.user_account_iocl_grid', {
            url: '/user_account_iocl_grid',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/user_account_iocl_grid.html',
                    controller: 'UserAccountIoclGridController'
                }
            }
        })
        .state('app.dashboard.user_account_pushpam_grid', {
            url: '/user_account_pushpam_grid',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/user_account_pushpam_grid.html',
                    controller: 'UserAccountPushpamGridController'
                }
            }
        })

        .state('app.dashboard.user_accounts_pushpam', {
            url: '/user_accounts_pushpam',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/user_accounts_pushpam.html',
                    controller: 'UserAccountPushpamController'
                }
            }
        })

         .state('app.dashboard.setting_email', {
             url: '/setting_email',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/setting_email.html'
                 }
             }
         })

         .state('app.dashboard.setting_sms', {
             url: '/setting_sms',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/setting_sms.html',
                     controller: 'SettingSMSController'
                 }
             }
         })
        .state('app.dashboard.setting_sms_grid', {
            url: '/setting_sms_grid',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/setting_sms_grid.html',
                    controller: 'SettingSmsGridController'
                }
            }
        })

         .state('app.dashboard.machine_activation', {
             url: '/machine_activation',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/machine_activation.html',
          ...
          .state('app.dashboard.syncronise', {
              url: '/syncronise',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/syncronise.html',
                      controller: 'SynchronizeSettingController'
                  }
              }
          })
         .state('app.dashboard.syncronize_grid', {
             url: '/syncronize_grid',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/syncronize_grid.html',
                     controller: 'GetSynchronizeSettingController'
                 }
             }
         })

          .state('app.dashboard.news_management', {
              url: '/news_management',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/news_management.html',
                      controller: 'NewsManagementController'
                  }
              }
          })

         .state('app.dashboard.news', {
             url: '/news',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/news.html',
                     controller: 'NewsController'
                 }
             }
         })

        .state('app.dashboard.image_management_grid', {
            url: '/image_management_grid',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/image_management_grid.html',
                    controller: 'ImageManagementGridController'
                }
            }
        })

        .state('app.dashboard.distributor_info', {
            url: '/distributor_info',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/distributor_info.html',
                    controller: 'DistInfoController'

                }
            }
        })

         .state('app.dashboard.image_management', {
             url: '/image_management',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/image_management.html',
                     controller: 'ImageManagementController'
                 }
             }
         })

         .state('app.dashboard.hierarchy', {
             url: '/hierarchy',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/hierarchy.html',
                     controller: 'HierarchyController'

                 }
             }
         })
         .state('app.dashboard.hierarchy_grid', {
             url: '/hierarchy_grid',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/hierarchy_grid.html',
                     controller: 'HierarchyGridController'
                 }
             }
         })
        .state('app.dashboard.update_hierarchy', {
            url: '/update_hierarchy',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/update_hierarchy.html',
                    controller: 'UpdateHierarchyController'
                }
            }
        })
        .state('app.dashboard.update_employee_to_hierarchy', {
            url: '/update_employee_to_hierarchy',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/update_employee_to_hierarchy.html',
                    controller: 'UpdateEmployeeHierarchyController'
                }
            }
        })
         .state('app.dashboard.manage_fr_hierarchy', {
             url: '/manage_fr_hierarchy',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/manage_fr_hierarchy.html',
                     controller: 'ManageFRHierarachyController'
                 }
             }
         })
         .state('app.dashboard.assign_and_view_hierarchy', {
             url: '/assign_and_view_hierarchy',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/assign_and_view_hierarchy.html',
                     controller: 'AssignViewHierarchyController'
                 }
             }
         })
             .state('app.dashboard.hierarchy_result', {
                 url: '/hierarchy_result',
                 views: {
                     "content@app": {
                         templateUrl: 'app/dashboard/partials/hierarchy_result.html',
                         controller: 'HirarchyResultcontroller'
                     }
                 }
             })
            .state('app.dashboard.add_remove_hierarchy', {
                url: '/add_remove_hierarchy',
                views: {
                    "content@app": {
                        templateUrl: 'app/dashboard/partials/add_remove_hierarchy.html',
                        controller: 'SingleAddRemovecontroller'
                    }
                }
            })
         .state('app.dashboard.rolestatus_grid', {
             url: '/rolestatus_grid',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/rolestatus_grid.html',
                     controller: 'RolestatusGridController'

                 }
             }
         })
         .state('app.dashboard.role_status', {
             url: '/role_status',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/role_status.html',
                     controller: 'RolestatusController'

                 }
             }
         })
          .state('app.dashboard.mainmenu_grid', {
              url: '/mainmenu_grid',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/mainmenu_grid.html',
                      controller: 'MainMenuGridController'

                  }
              }
          })
        .state('app.dashboard.forms_grid', {
            url: '/forms_grid',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/forms_grid.html',
                    controller: 'FormsGridController'
                }
            }
        })
        .state('app.dashboard.forms', {
            ...
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/forms.html',
                    controller: 'FormsController'
                }
            }
        })
        .state('app.dashboard.main_menu', {
            url: '/main_menu',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/main_menu.html',
                    controller: 'MainMenuController'

                }
            }
        })
          .state('app.dashboard.userauth_grid', {
              url: '/userauth_grid',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/userauth_grid.html',
                      controller: 'UserAuthGridController'

                  }
              }
          })
         .state('app.dashboard.user_auth', {
             url: '/user_auth',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/user_auth.html',
        ...
        .state('app.dashboard.ezytap_onboard_grid', {
            url: '/ezytap_onboard_grid',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/ezytap_onboard_grid.html',
                    controller: 'EzyTapController'
                }
            }
        })
        .state('app.dashboard.ezytap_onboard', {
            url: '/ezytap_onboard',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/ezytap_onboard.html',
                    controller: 'PostPutEzyTapController'
                }
            }
        })

        .state('app.dashboard.adhar_onboard_grid', {
            url: '/adhar_onboard_grid',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/adhar_onboard_grid.html'
                }
            }
        })
        .state('app.dashboard.adhar_onboard', {
            url: '/adhar_onboard',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/adhar_onboard.html'
                }
            }
        })
         .state('app.dashboard.citrus_onboard_grid', {
             url: '/citrus_onboard_grid',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/citrus_onboard_grid.html',
                     controller: 'CitrusTapController'
                 }
             }
         })
        .state('app.dashboard.citrus_onboard', {
            url: '/citrus_onboard',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/citrus_onboard.html',
                    controller: 'PostPutCitrusTapController'
                }
            }
        })
         ...
         .state('app.dashboard.Manage_coupon', {
             url: '/Manage_coupon',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/Manage_coupon.html',
                     controller: 'ManageCouponController'
                 }
             }
         })

        .state('app.dashboard.manage_coupon_view', {
            url: '/manage_coupon_view',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/manage_coupon_view.html',
                    controller: 'ManageCouponViewController'
                }
            }
        })

          .state('app.dashboard.new_coupon_grid', {
              url: '/new_coupon_grid',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/new_coupon_grid.html',
                      controller: 'NewCouponGridGridController'
                  }
              }
          })

        .state('app.dashboard.new_coupon', {
            url: '/new_coupon',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/new_coupon.html',
                    controller: 'NewCouponController'
                }
            }
        })

          .state('app.dashboard.make_payment_grid', {
              url: '/make_payment_grid',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/make_payment_grid.html',
                      controller: 'VerifyPaymentGridController'

                  }
              }
          })

         .state('app.dashboard.make_payment', {
             url: '/make_payment',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/make_payment.html',
                     controller: 'VerifyPaymentController'
                 }
             }
         })

         .state('app.dashboard.outword_management_grid', {
             url: '/outword_management_grid',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/outword_management_grid.html',
                     controller: 'OutwordManagementGridController'
                 }
             }
         })
         .state('app.dashboard.Pending_Order_grid', {
             url: '/Pending_Order_grid',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/PendingOrder.html',
                     controller: 'PendingOrderGridController'
                 }
             }
         })
         ...
         .state('app.dashboard.outword_process', {
             url: '/outword_process',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/outword_process.html',
                     controller: 'OutwordManagementController'
                 }
             }
         })

          .state('app.dashboard.opf_grid', {
              url: '/opf_grid',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/opf_grid.html',
                      controller: 'OPFGridController'
                  }
              }
          })
         .state('app.dashboard.opf_manage', {
             url: '/opf_manage',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/opf_manage.html',
                     controller: 'ManageOPFController'
                 }
             }
         })
         .state('app.dashboard.update_opf', {
             url: '/update_opf',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/update_opf.html',
                     controller: 'OPFUpdateController'
                 }
             }
         })
         .state('app.dashboard.dispatch_grid', {
             url: '/dispatch_grid',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/dispatch_grid.html',
                     controller: 'DispatchGridController'
                 }
             }
         })


          .state('app.dashboard.manage_dispatch', {
              url: '/manage_dispatch',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/manage_dispatch.html',
                      controller: 'DispatchManageController'
                  }
              }
          })

           .state('app.dashboard.cancellation_report_grid', {
               url: '/cancellation_report_grid',
               views: {
                   "content@app": {
                       templateUrl: 'app/dashboard/partials/cancellation_report_grid.html',
                       controller: 'CancellationRequestGridController'

                   }
               }
           })
          .state('app.dashboard.cancellation_report', {
              url: '/cancellation_report',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/cancellation_report.html',
                      controller: 'CancellationRequestController'
                  }
              }
          })
               .state('app.dashboard.orderdoc_report_grid', {
                   url: '/orderdoc_report_grid',
                   views: {
                       "content@app": {
                           templateUrl: 'app/dashboard/partials/orderdoc_report_grid.html',
                           controller: 'orderDocGridController'

                       }
                   }
               })
        .state('app.dashboard.outward_summary_report', {
            url: '/outward_summary_report',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/outward_summary_report.html',
                    controller: 'OutwardSummaryController'

                }
            }
        })
           .state('app.dashboard.outward_summary_report_details', {
               url: '/outward_summary_report_details',
               views: {
                   "content@app": {
                       templateUrl: 'app/dashboard/partials/outward_summary_report_details.html',
                       controller: 'OutwardDetailsController'

                   }
               }
           })
             .state('app.dashboard.inward_summary_report', {
                 url: '/inward_summary_report',
                 views: {
                     "content@app": {
                         templateUrl: 'app/dashboard/partials/inward_summary_report.html',
                         controller: 'InwardSummaryController'

                     }
                 }
             })
           .state('app.dashboard.inward_summary_report_details', {
               url: '/inward_summary_report_details',
               views: {
                   "content@app": {
                       templateUrl: 'app/dashboard/partials/inward_summary_report_details.html',
                       controller: 'InwardDetailsController'

                   }
               }
           })
           .state('app.dashboard.update_invoice_details', {
               url: '/update_invoice_details',
               views: {
                   "content@app": {
                       templateUrl: 'app/dashboard/partials/update_invoice_details.html',
                       controller: 'InvoiceDetailsController'

                   }
               }
           })
          .state('app.dashboard.distributor_credit_debit_details', {
              url: '/distributor_credit_debit_details',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/distributor_credit_debit_details.html',
                      controller: 'DistCrDrDetailController'

                  }
              }
          })
           .state('app.dashboard.new_connection_request_summary', {
               url: '/new_connection_request_summary',
               views: {
                   "content@app": {
                       templateUrl: 'app/dashboard/partials/new_connection_request_summary.html',
                       controller: 'NewConnectionReqSummaryController'

                   }
               }
           })

           .state('app.dashboard.new_connection_request_detail', {
               url: '/new_connection_request_detail',
               views: {
                   "content@app": {
                       templateUrl: 'app/dashboard/partials/new_connection_request_detail.html',
                       controller: 'NewConnectionReqDtlsController'
        ...
        //safety
        .state('app.dashboard.manage_question_master_grid', {
            url: '/manage_question_master_grid',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/manage_question_master_grid.html',
                    controller: 'ManageQuestionMasterGridController'
                }
            }
        })

         .state('app.dashboard.manage_question_master', {
             url: '/manage_question_master',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/manage_question_master.html',
                     controller: 'ManageQuestionMasterController'
                 }
             }
         })

        //report
         .state('app.dashboard.license_validity_report', {
             url: '/license_validity_report',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/license_validity_report.html',
                     controller: 'licensevalidityController'
                 }
             }
         })

         .state('app.dashboard.syncerrorlog_report', {
             url: '/syncerrorlog_report',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/SynchroniseErrorLog.html',
                     controller: 'SyncErrorLogController'
                 }
             }
         })
                 .state('app.dashboard.view_hierarchy', {
                     url: '/view_hierarchy',
                     views: {
                         "content@app": {
                             templateUrl: 'app/dashboard/partials/view_hierarchy.html',
                             controller: 'ViewHierarchyController'

                         }
                     }
                 })

         .state('app.dashboard.Get_OPFDetails', {
             url: '/Get_OPFDetails',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/GetOPFDetails.html',
                     controller: 'GetOPFDetailsController'

                 }
             }
         })

                 .state('app.dashboard.distributor_wise_feedback_report', {
                     url: '/distributor_wise_feedback_report',
                     views: {
                         "content@app": {
                             templateUrl: 'app/dashboard/partials/distributor_wise_feedback_report.html',
                             controller: 'DistributorWiseFeedbackReport'
                         }
                     }
                 })

             .state('app.dashboard.consumer_feedback_report', {
                 url: '/consumer_feedback_report',
                 views: {
                     "content@app": {
                         templateUrl: 'app/dashboard/partials/consumer_feedback_report.html',
                         controller: 'consumerNumberwiseReviewCtrl'
                     }
                 }
             })

             .state('app.dashboard.consumer_area_feedback_report', {
                 url: '/consumer_area_feedback_report',
                 views: {
                     "content@app": {
                         templateUrl: 'app/dashboard/partials/consumer_area_feedback_report.html',
                         controller: 'ConsumerReviewAreawiseController'
                     }
                 }
             })

          .state('app.dashboard.consumer_feedback_areawise_summary', {
              url: '/consumer_feedback_areawise_summary',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/consumer_feedback_areawise_summary.html',
                      controller: 'consumerReviewAreaCtrl'
                  }
              }
          })
          .state('app.dashboard.consumer_feedback_delivery_boywise_summary', {
              url: '/consumer_feedback_delivery_boywise_summary',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/consumer_feedback_delivery_boywise_summary.html',
                      controller: 'consumerReviewBoywiseCtrl'
                  }
              }
          })
          .state('app.dashboard.order_detail_report', {
              url: '/order_detail_report',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/order_detail_report.html',
                      controller: 'OrderDetailsController'
                  }
              }
          })
         .state('app.dashboard.order_in_report', {
             url: '/order_in_report',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/order_in_Details.html',
                     controller: 'OrderInDetailsController'
                 }
             }
         })

         .state('app.dashboard.dispatch_detail_report', {
             url: '/dispatch_detail_report',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/dispatch_details_report.html',
                     controller: 'DispatchDetailsController'
                 }
             }
         })

           .state('app.dashboard.reject_log', {
               url: '/reject_log',
               views: {
                   "content@app": {
                       templateUrl: 'app/dashboard/partials/reject_log.html',
                       controller: 'RejectLogController'
                   }
               }
           })
          .state('app.dashboard.opf_amc_log', {
              url: '/opf_amc_log',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/opf_amc_log.html',
                      controller: 'OPFAMCLogController'
                    
                  }
              }
          })

                .state('app.dashboard.update_amc_invoice', {
                    url: '/update_amc_invoice',
                    views: {
                        "content@app": {
                            templateUrl: 'app/dashboard/partials/update_amc_invoice.html'
          ...
          .state('app.dashboard.update_reject_log', {
              url: '/update_reject_log',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/update_reject_log.html',
                      controller: 'UpdateRejectLogController'
                  }
              }
          })
        .state('app.dashboard.inward_product_report', {
            url: '/inward_product_report',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/inward_product_report.html',
                    controller: 'InwardProductReportController'
                }
            }
        })
          .state('app.dashboard.payment_detail_report', {
              url: '/payment_detail_report',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/payment_detail_report.html',
                      controller: 'PaymentDetailsController'
                  }
              }
          })
          .state('app.dashboard.outward_detail_report', {
              url: '/outward_detail_report',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/outward_detail_report.html',
                      controller: 'OutwardDetailsController'
                  }
              }
          })
          .state('app.dashboard.user_authentication', {
              url: '/user_authentication',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/user_authentication.html',
                      controller: 'UserAuthenticationController'
                  }
              }
          })

         .state('app.dashboard.refill_del_count_report', {
             url: '/refill_del_count_report',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/refill_del_count_report.html',
                     controller: 'RefillDeliveryCountReportController'
                 }
             }
         })

           .state('app.dashboard.digital_pay_count_report', {
               url: '/digital_pay_count_report',
               views: {
                   "content@app": {
                       templateUrl: 'app/dashboard/partials/digital_pay_count_report.html',
                       controller: 'DigPaymentDashboardHistoryReportController'
                   }
               }
           })
         .state('app.dashboard.booking_count_report', {
             url: '/booking_count_report',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/booking_count_report.html',
                     controller: 'BookingCountReportController'
                 }
             }
         })
        .state('app.dashboard.ezygas_card_activation_count', {
            url: '/aegis_card_activation_count',
            views: {
                "content@app": {
                    templateUrl: 'app/dashboard/partials/ezygas_card_activation_count.html',
                    controller: 'CardActReportController'
                }
            }
        })
         ...
         .state('app.dashboard.user_authentication_add', {
             url: '/user_authentication_add',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/user_authentication_add.html',
                     controller: 'AuthenticationController'
                 }
             }
         })
         .state('app.dashboard.rejected_orders', {
             url: '/rejected_orders',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/rejected_orders.html',
                     controller: 'RejectOrdersController'
                 }
             }
         })
          .state('app.dashboard.opening_pay_count', {
              url: '/opening_pay_count',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/opening_pay_count.html',
                      controller: 'OpeningPayCountController'
                  }
              }
          })
        //analytical report
         .state('app.dashboard.distributor_payment_gateway_report', {
             url: '/distributor_payment_gateway_report',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/distributor_payment_gateway_report.html',
                     controller: 'PaymentGatewayGridController'
                 }
             }
         })

         .state('app.dashboard.daily_transaction_report', {
             url: '/daily_transaction_report',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/daily_transaction_report.html',
                     controller: 'DailyTransactionController'
                 }
             }
         })
              .state('app.dashboard.delivery_man_wise_report', {
                  url: '/delivery_man_wise_report',
                  views: {
                      "content@app": {
                          templateUrl: 'app/dashboard/partials/delivery_man_wise_report.html',
                          controller: 'DeliveryManwiseGridController'
                      }
                  }
              })

         .state('app.dashboard.transsummary_wise_report', {
             url: '/transsummary_wise_report',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/transsummary_wise_report.html',
                     controller: 'TransSummDeliveryManwiseGridController'
                 }
             }
         })
         .state('app.dashboard.dist_pdevice_count_report', {
             url: '/dist_pdevice_count_report',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/dist_pdevice_count_report.html',
                     controller: 'DistWisePDeviceCountController'
                 }
             }
         })
         //log
         .state('app.dashboard.api_response_log', {
             url: '/api_response_log',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/api_response_log.html',
                     controller: 'ApiResponseLogController'
                 }
             }
         })
               //Migration
         .state('app.dashboard.data_migration_log', {
             url: '/data_migration_log',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/DataMigrationLog.html',
                     controller: 'DataMigrationLoghGridController'
                 }
             }
         })
        //onboarding
           .state('app.dashboard.distributor_onboarding', {
               url: '/distributor_onboarding',
               views: {
                   "content@app": {
                       templateUrl: 'app/dashboard/partials/distributor_onboarding.html',
                       controller: 'DistributorOnboadringController'
                   }
               }
           })
         .state('app.dashboard.distributor_grid', {
             url: '/distributor_grid',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/distributor_grid.html',
                     controller: 'DistributorOnboardingGridController'
                 }
             }
         })
          ...
          .state('app.dashboard.change_password', {
              url: '/change_password',
              views: {
                  "content@app": {
                      templateUrl: 'app/dashboard/partials/change_password.html',
                      controller: 'ChangePasswordController'
                  }
              }
          })

         .state('app.dashboard.photo_upload', {
             url: '/photo_upload',
             views: {
                 "content@app": {
                     templateUrl: 'app/dashboard/partials/photo_upload.html',
                     controller: 'PhotoUploadController'
                 }
             }
         })
       .state('app.dashboard.order_navigator', {
           url: '/order_navigator',
           views: {
               "content@app": {
                   templateUrl: 'app/dashboard/partials/order_navigator.html',
                   controller: 'OrderNavigatorController'
               }
           }
       })
});

appdash.constant('Name', 'diglpg');
appdash.constant('Password', 'diglpg@12345?');
appdash.constant('flag', flagdata);
appdash.run(function (cfCryptoHttpInterceptor, $rootScope) {
    $rootScope.base64Key = CryptoJS.enc.Utf8.parse('GGAS112233445566');
    $rootScope.iv = CryptoJS.enc.Utf8.parse('GGAS112233445566');
});
//GOGAS Production Link
//appdash.constant('amcproductcode', '1012');
//appdash.constant('uri', 'http://diglpg.gogas.co/api/');
//appdash.constant('uriadmin', 'http://mygogasapi.gogas.co/api/');
//appdash.constant('urisafety', 'http://mygogasapi.gogas.co/api/');
//appdash.constant('uriadminimage', 'http://mygogasapi.gogas.co/sliderimages/');
//appdash.constant('uriproductimage', 'http://mygogasapi.gogas.co/productimages/');
//appdash.constant('uriuserimage', 'http://mygogasapi.gogas.co/userimages/');
//appdash.constant('uripaygateway', 'http://mygogasapi.gogas.co/pgatewayimages/');
//appdash.constant('imageurl', 'http://mygogasapi.gogas.co/');
//appdash.constant('noimage', 'http://mygogasapi.gogas.co/api/');
//appdash.constant('urianalysis', 'http://diganalysis.gogas.co/api/');
//appdash.constant('uripdf', 'http://mygogasapi.gogas.co/opf/');
//appdash.constant('uridigezygas', 'http://digEzygas.gogas.co/api/');
//appdash.constant('PreLoginUrl', 'http://distributor.gogas.co/dashboard/dashboard_ezy_gas?');
//appdash.constant('placeorderurl', 'http://distributor.gogas.co/dashboard/place_an_order?');
//appdash.constant('vieworderurl', 'http://distributor.gogas.co/dashboard/view_order?');
//appdash.constant('acceptorderurl', 'http://distributor.gogas.co/dashboard/accept_orders?');
//appdash.constant('uricydl', 'http://digcyldel.gogas.co/api/')


// GOGAS Development Link
appdash.constant('amcproductcode', '1009');
appdash.constant('uri', 'http://192.168.1.216:8080/diglpg/api/');
appdash.constant('uriadmin', 'http://192.168.1.216:8080/mygogasapi/api/');
appdash.constant('urisafety', 'http://192.168.1.216:8080/mygogasapi/api/');
appdash.constant('uriadminimage', 'http://192.168.1.216:8080/mygogasapi/sliderimages/');
appdash.constant('uriproductimage', 'http://192.168.1.216:8080/mygogasapi/productimages/');
appdash.constant('uriuserimage', 'http://192.168.1.216:8080/mygogasapi/userimages/');
appdash.constant('uripaygateway', 'http://192.168.1.216:8080/mygogasapi/pgatewayimages/');
appdash.constant('imageurl', 'http://192.168.1.216:8080/mygogasapi/');
appdash.constant('noimage', 'http://192.168.1.216:8080/mygogasapi/api/');
appdash.constant('urianalysis', 'http://192.168.1.216:8080/diganalysis/api/');
appdash.constant('uripdf', 'http://192.168.1.216:8080/mygogasapi/opf/');
appdash.constant('uridigezygas', 'http://192.168.1.216:8080/digEzygas/api/');
appdash.constant('PreLoginUrl', 'http://192.168.1.91/gogas/dashboard/dashboard_ezy_gas?');
appdash.constant('placeorderurl', 'http://192.168.1.91/gogas/dashboard/place_an_order?');
appdash.constant('vieworderurl', 'http://192.168.1.91/gogas/dashboard/view_order?');
appdash.constant('acceptorderurl', 'http://192.168.1.91/gogas/dashboard/accept_orders?');
appdash.constant('uricydl', 'http://192.168.1.216:8080/digcyldel/api/')


//GOGAS sandbox link
//appdash.constant('amcproductcode', '1009');
//appdash.constant('uri', 'http://diglpg.staging.sipl.pw/api/');
//appdash.constant('uriadmin', 'http://mygogasapi.staging.sipl.pw/api/');
//appdash.constant('urisafety', 'http://mygogasapi.staging.sipl.pw/api/');
//appdash.constant('uriadminimage', 'http://mygogasapi.staging.sipl.pw/sliderimages/');
//appdash.constant('uriproductimage', 'http://mygogasapi.staging.sipl.pw/productimages/');
//appdash.constant('uriuserimage', 'http://mygogasapi.staging.sipl.pw/userimages/');
//appdash.constant('uripaygateway', 'http://mygogasapi.staging.sipl.pw/pgatewayimages/');
//appdash.constant('imageurl', 'http://mygogasapi.staging.sipl.pw/');
//appdash.constant('noimage', 'http://mygogasapi.staging.sipl.pw/api/');
//appdash.constant('urianalysis', 'http://diganalysis.staging.sipl.pw/api/');
//appdash.constant('uripdf', 'http://mygogasapi.staging.sipl.pw/opf/');
//appdash.constant('uridigezygas', 'http://digEzygas.staging.sipl.pw/api/');
//appdash.constant('PreLoginUrl', 'http://gogas.staging.sipl.pw/dashboard/dashboard_ezy_gas?');
//appdash.constant('placeorderurl', 'http://gogas.staging.sipl.pw/dashboard/place_an_order?');
//appdash.constant('vieworderurl', 'http://gogas.staging.sipl.pw/dashboard/view_order?');
//appdash.constant('acceptorderurl', 'http://gogas.staging.sipl.pw/dashboard/accept_orders?');
//appdash.constant('uricydl', 'http://digcyldel.staging.sipl.pw/api/')


appdash.factory('userService', function ($sessionStorage, $filter, $http, $state, $rootScope, uriadmin, SmartAlert) {

    var enable = [];
    var self;
    return {
        Success: function (Message) {
            if ($sessionStorage.RoleStatus != '*') {
                enable = $filter('filter')($sessionStorage.Formstatus, { FormNumber: Message })[0];
                if (enable != null) {
                    if (enable.IsFormEnable == null && $sessionStorage.RoleStatus == 'Y') {
                        var filterall = 'N';
                    }
                    else if (enable.IsFormEnable == null && $sessionStorage.RoleStatus == 'N') {
                        var filterall = 'Y';
                    }
                    else {
                        var filterall = $sessionStorage.RoleStatus;
                    }
                }
                if (filterall == 'Y') {
                    if (enable.IsFormEnable == 'N') {
                        $state.go($sessionStorage.currentstate);
                        // SmartAlert.Errmsgauth('You are not authenticated'); 
                        return 'N';
                    }
                    else { return 'Y'; }
                }
...
appdash.directive('alphanumericonly', function () {
    return {
        require: 'ngModel',
        link: function (scope, element, attr, ngModelCtrl) {
            function fromUser(text) {
                var transformedInput = text.replace(/[^a-zA-Z0-9]*$/, '');// "/^[a-zA-Z0-9]*$/"
...
appdash.directive('decimalPlaces', function () {
    return {
...
appdash.directive("datepicker", function () {
    return {
        restrict: "A",
        require: "ngModel",
...
appdash.directive('capitalize', function () {
    return {
        require: 'ngModel',
...
appdash.directive('alphaonly', function () {
    return {
        require: 'ngModel',
        link: function (scope, element, attr, ngModelCtrl) {
            function fromUser(text) {
                var transformedInput = text.replace(/[^a-zA-Z.']*$/, '');// "/^[a-zA-Z0-9]*$/"
...
appdash.directive('specialsymbol', function () {
    return {
        require: 'ngModel',
        link: function (scope, element, attr, ngModelCtrl) {
            function fromUser(text) {
                var transformedInput = text.replace(/[^a-zA-Z.'_!@#$%^&*()]*$/, '');// "/^[a-zA-Z0-9]*$/"
                if (transformedInput !== text) {
                    ngModelCtrl.$setViewValue(transformedInput);
                    ngModelCtrl.$render();
                }
...
appdash.directive('numericonly', function () {
    return {
        require: 'ngModel',
        link: function (scope, element, attr, ngModelCtrl) {
            function fromUser(text) {
                var transformedInput = text.replace(/[^0-9]/g, '');// "/^[a-zA-Z0-9]*$/"
                if (transformedInput !== text) {
                    ngModelCtrl.$setViewValue(transformedInput);
                    ngModelCtrl.$render();
                }
...
appdash.directive('numericfloat', function () {
    return {
        require: 'ngModel',
        link: function (scope, element, attr, ngModelCtrl) {
            function fromUser(text) {
...
appdash.directive('numericfloatfive', function () {
    return {
        require: 'ngModel',
        link: function (scope, element, attr, ngModelCtrl) {
            function fromUser(text) {
                var transformedInput = text.replace(/(\.[\d]{5})./g, '$1');
                if (transformedInput !== text) {
                    ngModelCtrl.$setViewValue(transformedInput);
                    ngModelCtrl.$render();
                }
...
appdash.directive('dateGreaterThan', function () {
    return {
        require: 'ngModel',
...
appdash.directive('touppercase', function () {
    return {
        require: 'ngModel',
        link: function (scope, element, attr, ngModelCtrl) {
            function fromUser(text) {
...
appdash.directive('tolowercase', function () {
    return {
        require: 'ngModel',
        link: function (scope, element, attr, ngModelCtrl) {
            function fromUser(text) {
...
//autoscroll to top
appdash.run(['$window', '$rootScope', '$location', '$state', '$timeout', function ($window, $rootScope, $location, $state, $timeout, $scope) {
...
angular.module('app.dashboard').controller('DashboardCtrl', function ($scope, $rootScope, $sessionStorage, $interval, CalendarEvent) {
...
app.controller('distributor_profile', ['$scope', function ($scope) {
    $scope.ChangePass = function (attrs) {
        $scope.value = false;
        if (attrs == 'n') {
            $scope.value = true;
        }
...
// angular.module('app.dashboard').controller('delivered_ordersctrl', ['$scope', function ($scope) {
app.controller('delivered_ordersctrl', ['$scope', function ($scope) {
...
app.controller('undelivered_ordersctrl', ['$scope', function ($scope) {
...
app.controller('card_issue_registerctrl', ['$scope', function ($scope) {
    $scope.value = false;
    $scope.get_details_btn_main = true;
    $scope.filtertext = 'Advanced Filter';
    $scope.ChangeDivs = function () {
...
app.controller('card_block_registerctrl', ['$scope', function ($scope) {
    $scope.value = false;
    $scope.get_details_btn_main = true;
    $scope.filtertext = 'Advanced Filter';
    $scope.ChangeDivs = function () {
...
app.controller('delivered_order_processing_timectrl', ['$scope', function ($scope) {
    $scope.value = false;
    $scope.get_details_btn_main = true;
    $scope.filtertext = 'Advanced Filter';
    $scope.ChangeDivs = function () {
...
app.controller('loginctrl', ['$scope', '$state', '$sessionStorage', '$interval', function ($scope, $state, $sessionStorage, $interval) {
    ...
    $scope.allItems = [{ "title": "Welcome to XPRESSGAS Admin – Digital LPG Delivery" }, { "title": "Welcome to XPRESSGAS Dashboard – Digital LPG Delivery" }];
    ...
    //  var data = [{ "title": "\u05d4\u05d0\u05ea\u05d2\u05e8 \u05d4\u05d1\u05d0: \u05db\u05da \u05ea\u05e8\u05d5\u05e1\u05e7 \u05d4\u05db\u05dc\u05db\u05dc\u05d4 \u05d4\u05e2\u05e0\u05e4\u05d4 \u05e9\u05dc \u05d3\u05d0\u05e2\u05e9", "link": "http:\/\/news.walla.co.il\/?w=\/\/2790612", "pubDate": "00:10" }, { "title": "\u05d1\u05e9\u05dc \u05d4\u05db\u05e8\u05ea \u05de\u05de\u05e9\u05dc\u05ea \u05e9\u05d1\u05d3\u05d9\u05d4 \u05d1\u05e4\u05dc\u05e1\u05d8\u05d9\u05df: \u05d4\u05e9\u05d2\u05e8\u05d9\u05e8 \u05d9\u05d6\u05d5\u05de\u05df \u05dc\u05e9\u05d9\u05d7\u05d4", "link": "http:\/\/news.walla.co.il\/?w=\/\/2790623", "pubDate": "00:15" }, { "title": "\u05de\u05d7\u05e7\u05e8: \u05d4\u05d0\u05d9\u05d9\u05d3\u05e1 \u05d4\u05ea\u05e4\u05e8\u05e5 \u05dc\u05e8\u05d0\u05e9\u05d5\u05e0\u05d4 \u05d1\u05e9\u05e0\u05d5\u05ea \u05d4-20 \u05d1\u05e7\u05d5\u05e0\u05d2\u05d5", "link": "http:\/\/news.walla.co.il\/?w=\/\/2790558", "pubDate": "05:45" }, { "title": "\u05e8\u05d0\u05e9 \u05d0\u05de\u05df: \u05dc\u05d0 \u05dc\u05d4\u05e4\u05e2\u05d9\u05dc \u05d0\u05ea \u05d4\u05d0\u05de\u05e6\u05e2\u05d9\u05dd \u05d4\u05de\u05d9\u05d5\u05d7\u05d3\u05d9\u05dd", "link": "http:\/\/news.walla.co.il\/?w=\/\/2790641", "pubDate": "06:00" }, { "title": "\u05dc\u05e8\u05d0\u05e9\u05d5\u05e0\u05d4 \u05d6\u05d4 7 \u05e9\u05e0\u05d9\u05dd: \u05de\u05d0\u05d5\u05ea \u05ea\u05d5\u05e9\u05d1\u05d9 \u05e2\u05d6\u05d4 \u05d9\u05e6\u05d0\u05d5 \u05dc\u05d4\u05ea\u05e4\u05dc\u05dc \u05d1\u05d4\u05e8 \u05d4\u05d1\u05d9\u05ea", "link": "http:\/\/news.walla.co.il\/?w=\/\/2790689", "pubDate": "10:12" }, { "title": "\u05d1\u05d7\u05d5\u05d3\u05e9 \u05e1\u05e4\u05d8\u05de\u05d1\u05e8 \u05d1\u05d9\u05dc\u05d9\u05e0\u05d5 \u05e2\u05d5\u05d3 \u05e9\u05e2\u05ea\u05d9\u05d9\u05dd \u05d5\u05d7\u05e6\u05d9 \u05e2\u05dc \u05d4\u05db\u05d1\u05d9\u05e9", "link": "http:\/\/www.globes.co.il\/news\/article.aspx?did=1000976251", "pubDate": "07:02" }, { "title": "\u05e0\u05d9\u05ea\u05d5\u05d7 \"\u05d2\u05dc\u05d5\u05d1\u05e1\": \u05e9\u05d5\u05e7 \u05d4\u05e8\u05db\u05d1 \u05d4\u05d9\u05e9\u05e8\u05d0\u05dc\u05d9 \u05de\u05e4\u05d2\u05d9\u05df \u05e2\u05d5\u05e6\u05de\u05d4 \u05d7\u05e8\u05d9\u05d2\u05d4", "link": "http:\/\/www.globes.co.il\/news\/article.aspx?did=1000976794", "pubDate": "07:36" }, { "title": "\u05de\u05d3\u05d3 \u05d2\u05dc\u05d5\u05d1\u05e1-\u05d4\u05d5\u05de\u05dc\u05e1 \u05dc\u05e1\u05e4\u05d8\u05de\u05d1\u05e8: \u05d4\u05de\u05d5\u05db\u05e8\u05d9\u05dd \u05dc\u05d0 \u05de\u05e9\u05d3\u05e8\u05d9\u05dd \u05dc\u05d7\u05e5", "link": "http:\/\/www.globes.co.il\/news\/article.aspx?did=1000977845", "pubDate": "07:26" }, { "title": "\u05de\u05d0\u05d7\u05d5\u05e8\u05d9 \u05d4\u05e7\u05dc\u05e2\u05d9\u05dd \u05e9\u05dc \u05d0\u05d9\u05e8\u05d5\u05e2 \u05d4\u05e4\u05d5\u05e8\u05de\u05d5\u05dc\u05d4 1 \u05d4\u05d2\u05e8\u05e0\u05d3\u05d9\u05d5\u05d6\u05d9 \u05d1\u05d9\u05e9\u05e8\u05d0\u05dc", "link": "http:\/\/www.globes.co.il\/news\/article.aspx?did=1000977872", "pubDate": "12:52" }, { "title": "\"\u05e1\u05d9\u05db\u05d5\u05d9 \u05d8\u05d5\u05d1 \u05e9\u05d1\u05e2\u05d5\u05d3 10 \u05e9\u05e0\u05d9\u05dd \u05d3\u05d9\u05e8\u05d4 \u05d1\u05ea\"\u05d0 \u05ea\u05e2\u05dc\u05d4 \u05de\u05d9\u05dc\u05d9\u05d0\u05e8\u05d3 \u05e9\u05e7\u05dc\"", "link": "http:\/\/www.globes.co.il\/news\/article.aspx?did=1000978042", "pubDate": "13:10" }, { "title": "\u05d1\u05d9\u05e7\u05e9\u05d5 2.12 \u05de' \u05e9' \u05e2\u05dc \u05d3\u05d9\u05e8\u05d4 \u05d1\u05e9\u05db\u05d5\u05e0\u05ea \u05d1\u05d1\u05dc\u05d9 \u05d1\u05ea\"\u05d0; \u05db\u05de\u05d4 \u05e7\u05d9\u05d1\u05dc\u05d5?", "link": "http:\/\/www.globes.co.il\/news\/article.aspx?did=1000977825", "pubDate": "13:46" }, { "title": "\u05d7\u05d3\u05e9 \u05d1\u05ea\"\u05d0: \u05d4\u05d7\u05e0\u05d9\u05d5\u05e4\u05df - \u05de\u05ea\u05e7\u05df \u05dc\u05d0\u05d5\u05e4\u05e0\u05d9\u05d9\u05dd \u05d1\u05de\u05e7\u05d5\u05dd \u05d7\u05e0\u05d9\u05d4 \u05dc\u05de\u05db\u05d5\u05e0\u05d9\u05ea", "link": "http:\/\/www.globes.co.il\/news\/article.aspx?did=1000978284", "pubDate": "15:27" }, { "title": "\u05e7\u05d5\u05d3\u05dd \u05d9\u05db\u05d1\u05d5\u05e9 \u05d0\u05ea \u05dc\u05d5\u05e0\u05d3\u05d5\u05df: \u05e9\u05d9 \u05d0\u05d2\u05e1\u05d9 \u05de\u05e2\u05d3\u05db\u05df \u05d0\u05ea \u05d7\u05d6\u05d5\u05df \u05d4\u05e8\u05db\u05d1 \u05d4\u05d7\u05e9\u05de\u05dc\u05d9 - \u05de\u05d4 \u05d4\u05e1\u05d9\u05db\u05d5\u05d9 \u05e9\u05dc\u05d5 \u05dc\u05d4\u05e6\u05dc\u05d9\u05d7 \u05d4\u05e4\u05e2\u05dd?", "link": "http:\/\/www.globes.co.il\/news\/article.aspx?did=1000978371", "pubDate": "18:02" }, { "title": "\u05db\u05e8\u05d9\u05d9\u05ea \u05d4\u05de\u05e0\u05d4\u05e8\u05d5\u05ea \u05d1\u05db\u05d1\u05d9\u05e9 1 \u05d4\u05d7\u05d3\u05e9 \u05d4\u05d5\u05e9\u05dc\u05de\u05d4 \u05d1\u05e2\u05dc\u05d5\u05ea 150 \u05de' \u05e9'", "link": "http:\/\/www.globes.co.il\/news\/article.aspx?did=1000978479", "pubDate": "20:59" }];
    var data = [{ "title": "Dummy News123123123123123123123213123123123233332313" }, { "title": "Default News123123123123123123123213123123123233332313" }, { "title": "News Here" }, { "title": "News Here" }];
...
//    }
//});
app.controller('NewsDisplayController', function ($http, $scope, $filter, $window, $interval, $state, $localStorage, $sessionStorage, $rootScope, base64, uri, uriadmin, Name, Password) {
    ...
    $scope.GetNews = function () {
        ...
        $http({
            ...
            for (var i = 0; i < response.data.Data.length; i++) {
                if ($window.location.hash == "/login" || $window.location.hash == "/forgot-password") {
    ...
    //        params:
    //            { NewsId: null, Location: null, Application: 'PU', IsActive: 'Y' }
    //    }).then(function (response) {
    ...
    //                    }
    //                }
    //                if ($window.location.hash == "#/dashboard/dashboard_My_Express_gas") {
    //                    if (response.data.Data[i].nLocation == 'D' && response.data.Data[i].nApplication == 'PU') {
    //                        $scope.allItems.push({ "title": response.data.Data[i].NewsHead, "nMarkBold": response.data.Data[i].nMarkBold });
    //                    }
    //                }
